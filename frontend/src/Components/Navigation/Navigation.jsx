    ...
    <div className='h-screen sticky top-0'>
        <div>
            ...
            <div className='space-y-6'>
                ...
                item-center' onClick={() => item.title === "Profile"?navigate(`/profile/${5}`):navigate(item.path)}>
                    {item.icon}
            ...
            <div className='py-10'>
                <Button 
                sx={{width:"100%", borderRadius:"29px", py:'15px', bgcolor:'#da7e3c', color:'white', }} variant='contained'>
                    Post
                </Button>
            </div>
        </div>
